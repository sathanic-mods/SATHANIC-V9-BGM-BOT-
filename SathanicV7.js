// BASED ON BGM BOT ITS USE BGM BOT
// AND BUG BOT UI CREASH FIXED
// SATHANIC V7
...
//bug database
const { trava1 } = require('./Sathanic trava configurer /trava1')
const { trava2 } = require('./Sathanic trava configurer /trava2')
const { trava3 } = require('./Sathanic trava configurer /trava3')
const { trava4 } = require('./Sathanic trava configurer /trava4')
const { trava5 } = require('./Sathanic trava configurer /trava5')
const { trava6 } = require('./Sathanic trava configurer /trava6')
const { trava7 } = require('./Sathanic trava configurer /trava7')
const { trava8 } = require('./Sathanic trava configurer /trava8')
const { trava9 } = require('./Sathanic trava configurer /trava9')
const { trava10 } = require('./Sathanic trava configurer /trava10')
const wkwk = fs.readFileSync(`./Sathanic trava configurer /x.mp3`)
const xsteek = fs.readFileSync(`./Sathanic trava configurer /x.webp`)
const o = fs.readFileSync(`./Sathanic trava configurer /o.jpg`)
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./SathanicData/thumb.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
mimetype: `image/null`,
fileName: `${sathanic}.${trava1}` ,
caption: `${sathanic + trava1}`,
}, {quoted: subscribe_sathanic })
}
//end bug functions
...
"LOADING..................................................................................................................................‹90%",
"LOADING....................................................................................................................................................‹100%",
"Adding...Sathan V7 Plugin floder."
]
let { key } = await XeonBotInc.sendMessage(from, {text: 'completed...'})
...
let audiobuffy = fs.readFileSync(`./SathanicData/audio/${BhosdikaXeon}.mp3`)
XeonBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./SathanicData/sticker/${BhosdikaXeon}.webp`)
XeonBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./SathanicData/image/${BhosdikaXeon}.jpg`)
XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./SathanicData/video/${BhosdikaXeon}.mp4`)
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./SathanicDataia/apk/${BhosdikaXeon}.apk`)
sendapk(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./SathanicData/zip/${BhosdikaXeon}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./SathanicData/doc/${BhosdikaXeon}.pdf`)
senddocu(buffer)
}
}
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/JRvMtzT/thumb.png',
...
`.trim()
            ...
            case 'donate':
            case 'donasi':
                let textnate = `𝖍𝖊𝖟 𝖇𝖗𝖔 ${pushname}\n\nNo matter how much you donate is very valuable for us \n G pay Number india 919778158839`
                XeonBotInc.sendMessage(m.chat, {
                    text: 'Upi id zok8969@okicici\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
break
            case 'addvideo': {
                ...
                VideoXeon.push(q)
                await fsx.copy(delb, `./SathanicData/video/${q}.mp4`)
            ...
            case 'delvideo': {
                ...
                fs.writeFileSync('./database/autoreply/video.json', JSON.stringify(VideoXeon))
                fs.unlinkSync(`./SathanicData/video/${q}.mp4`)
            ...
            case 'addimage': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                ImageXeon.push(q)
                await fsx.copy(delb, `./SathanicData/image/${q}.jpg`)
            ...
            case 'delimage': {
                ...
                fs.writeFileSync('./database/autoreply/image.json', JSON.stringify(ImageXeon))
                fs.unlinkSync(`./SathanicData/image/${q}.jpg`)
            ...
            case 'addsticker': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                StickerXeon.push(q)
                await fsx.copy(delb, `./SathanicData/sticker/${q}.webp`)
            ...
            case 'delsticker': {
                ...
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerXeon))
                fs.unlinkSync(`./SathanicData/sticker/${q}.webp`)
            ...
            case 'addvn': {
                ...
                await fsx.copy(delb, `./SathanicData/audio/${q}.mp3`)
            ...
            case 'delvn': {
                ...
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteXeon))
                fs.unlinkSync(`./SathanicData/audio/${q}.mp3`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ZipXeon.push(teks)
await fsx.copy(delb, `./SathanicData/zip/${teks}.zip`)
...
fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(`./SathanicData/zip/${teks}.zip`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./SathanicData/apk/${teks}.apk`)
...
fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(`./SathanicData/apk/${teks}.apk`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
await fsx.copy(delb, `./SathanicData/doc/${teks}.pdf`)
...
fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(`./SathanicData/doc/${teks}.pdf`)
...
break
            case 'afk':
                ...
                break
case 'play':  case 'song': {
if (!text) return replygcxeon(`Example : ${prefix + command} malayalam ringtone`)
...
case 'loveda':
case 'lovesong':
XeonBotInc_dev = await getBuffer(`https://github.com/sathanic-mods/Tiktokmusic-API/raw/main/tiktokmusic/${command}.mp3`)
...
break
case '𝕾𝖆𝖙𝖍𝖆𝖓𝖎𝖈 𝖁7':
xeonimun('𝙎𝘼𝙏𝙃𝘼𝙉𝙄𝘾 𝙑7 \n 𝘽𝙂𝙈 𝘽𝙊𝙏')
break
            case 'sathan':
            case 'bot':
                let xeonmenuoh = `ꪑꪮꪀꫀ ᦔꪖ ${pushname}
${xeonytimewisher}
────────────────────────⭓
𝗦𝗔𝗧𝗛𝗔𝗡𝗜𝗖 𝗩7 ♪ 𝗕𝗚𝗠 𝗕𝗢𝗧  
...
┃☯︎╭───────────────────────────────❍
┃☯︎│
┃☯︎│ _*ᴏᴡɴᴇʀ*_ : 𝕾𝖆𝖙𝖍𝖆𝖓𝖎𝖈
┃☯︎│ _*ᴜsᴇʀ*_ :  ❍❍❍❍❍
┃☯︎│ _*ᴍᴏᴅᴇ*_ : sᴇʟғ
┃☯︎│ _*sᴇʀᴠᴇʀ*_ : ᴛᴇʀᴍᴜx (ʜᴏsᴛ)
┃☯︎│ _*ᴀᴠᴀɪʟᴀʙʟᴇ ʀᴀᴍ*_ : 346 ᴍʙ ᴏғ 483 ᴍʙ
┃☯︎│ _*ᴠᴇʀsɪᴏɴ*_ : ᴠ7.0.0
┃☯︎│
┃☯︎│  ▎▍▌▌▉▏▎▌▉▐▏▌▎
┃☯︎│  ▎▍▌▌▉▏▎▌▉▐▏▌▎
┃☯︎│     sᴀᴛʜᴀɴɪᴄ ᴠ7
...
if (typemenu === 'v1') {
                    ...
                    XeonBotInc.sendMessage(m.chat, {
      video: fs.readFileSync('./SathanicData/thumb2.mp4'),
      gifPlayback: true,
      caption: xeonmenuoh,
      contextInfo: {
      externalAdReply: {
